...
import java.sql.*;
        ...
        class studentfail
        {
            ...
            studentfail()
            {
                JFrame f=new JFrame("Student who Failed");
                 p1=new JPanel()
                        {
           public void paintComponent(Graphics g)
			{
				...
				g.drawImage(t,0,0,this);
                 ...
                 f.setSize(600,400);
                l1=new JLabel("Total No. of Students Registered");
                Font f16=new Font("ComicSans Ms",Font.BOLD,16);   
       l1.setFont(f16);
                        l1.setForeground(Color.WHITE);
                l2=new JLabel("No. of Students Who failed");
         ...
         public void connection()
        {
            try
            {
               Class.forName("com.mysql.jdbc.Driver");
                con1=DriverManager.getConnection("jdbc:mysql://localhost:3306/rajatproject","root","");
            ...
            catch(Exception ab)
            {
                System.out.println("Connection Error"+ab);
                    ...
                    class stupasssss
                    {
                        ...
                        {
                            studentfail obj=new studentfail();
                        }
